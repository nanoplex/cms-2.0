(function() {
    ...
    Object.observe(installer, function(change) {
        for (var i = 0; i < change.length; i++) {
            ...
            if (change[i].name == "Loglevel") {
                ...
                if (level === "0") document.getElementById("loglevelstauts").innerHTML = "Error only";
                else if (level === "1") document.getElementById("loglevelstauts").innerHTML = "Warnings";
                else if (level === "2") document.getElementById("loglevelstauts").innerHTML = "All events";
    ...
    installer.HandleSite = function(res) {
        ...
        if (res.detail.response.match(/true/) != null) window.location.href = "/index.html";
        else this.$.siteStatus.innerHTML = res.detail.response;
    ...
    installer.Finish = function() {
        ...
        if (document.querySelector("input[name=sitename]").validity.valid) this.$.ajaxSite.go();
        else this.$.siteStatus.innerHTML = "you must enter a name for your project";
